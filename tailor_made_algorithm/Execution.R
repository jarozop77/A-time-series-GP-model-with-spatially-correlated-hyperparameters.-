...
#Malaria data
malaria_data = readRDS(file = "data/simulated_data.RDS")
summary(malaria_data)

#Shapefile 

shp_file = readRDS(file = "data/district_boundaries.RDS")
...
source("tailor_made_algorithm/Inputs_sampler.R")
...
source("tailor_made_algorithm/sampler.R")
...
saveRDS(sampler_mcmc, file = "outputs/tailor_made_algorithm/model_fitted.RDS")
